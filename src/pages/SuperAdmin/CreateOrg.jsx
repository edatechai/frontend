...
//        type="text" placeholder="Organization name" className="input input-bordered w-full min-w-full" />
//       </div>
...
//        type="text" placeholder="Organization Contact Full Name" className="input input-bordered w-full min-w-full" />
//       </div>
...
//       type="text" placeholder="Organization Contact Email" className="input input-bordered w-full min-w-full" />
//       </div>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-6 rounded-lg shadow-lg w-1/2">
        ...
        <p><strong>Number of Licenses:</strong> {license.numberOfLicense}</p>
                ...
                <tbody>
                  {data?.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td>{item.numberOfLicense}</td>
                      <td>
                        <span className='badge badge-ghost badge-sm cursor-pointer' onClick={() => handleViewLicense(item)}>View License</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
