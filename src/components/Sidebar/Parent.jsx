...
const Sidebar = () => {
  ...
  return (
    ...
    <ul className='mt-5'>
      ...
      <SidebarButton to='/parent' label='Dashboard' active="dashboard" icon={<MdOutlineDashboard />}/>
      ...
      <div className='flex flex-col'>
        <div className='mb-10'>
          <div className='cursor-pointer flex items-center text-white' onClick={logout}>
            <IoIosLogOut size={20} className='mr-2 text-white' /> Logout
          </div>
        </div>
        <div className='text-[10px] text-center mb-5 text-white'>All Rights Reserved ©2024</div>
      </div>
      </div>
   </div>
    </>
