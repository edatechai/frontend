...
import {useFindAllQuizQuery, useGetAllClassRoomByAccountIdQuery, 
  useQuizRandomSelectMutation,
  useFindAllQuizByIdQuery,
  useJoinClassMutation, useFindMyClassesTeacherQuery, 
  useFindAllObjectivesQuery, useCreateQuizMutation } from "../../features/api/apiSlice";
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-7">
            ...
            <div className="card-body px-3 py-3">
              ...
              <div className="card-actions justify-end">
                  <div className='px-3 justify-center'>
                    ...
                    to="/dashboard/quiz" state={{ data: i }} 
                    >
        ...
        {
          AllQuiz?.length === 0 && <div className='text-center'>No Quiz Found</div>
        }
