                ...
                <div key={index} className="">
                  <div className="card bg-white text-primary-content lg:w-[100%] lg:h-[250px] p-3  ">
                    <div className="card-body lg:px-3 px-3  ">
                      <h2 className="card-title text-green-700 p-2 bg-green-50 text-sm lg:text-lg rounded-sm font-normal">
                        {i?.classTitle}
                      </h2>
                      <p className="text-slate-800">
                        Welcome to {i?.classTitle}
                      </p>
                      <div className="card-actions justify-end lg:justify-start  mt-3">
                        <Link
                          ...
                          state={{ data: i?._id }}
                        >
                          <button className="btn bg-blue-600 font-normal text-white hover:bg-black">
                            Enter Classroom
                          </button>
                        </Link>
                      </div>
                    ...
                    <>
                      {quizResult?.data.map((item, index) => {
                        return (
                          <div
                            key={index}
                            className="collapse collapse-plus bg-white mt-2 mb-2"
                          >
                            <input
                              type="radio"
                              name="my-accordion-3"
