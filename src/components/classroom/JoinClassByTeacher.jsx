...
import {  useGetAllClassRoomByAccountIdQuery, useJoinClassMutation, useFindMyClassesTeacherQuery } from "../../features/api/apiSlice"
                    ...
                    <div className="card bg-white border-2 border-slate-300 text-primary-content w-96 h-[250px]  ">
                        <div className="card-body">
                            ...
                            <div className='flex gap-4'>
                               <div className='text-slate-950 flex align-middle'>Number of student(s) in this class</div>
                            <div className='flex justify-center items-center gap-2 text-black'> <FiUsers className='text-black'/>  {i?.numberOfStudents.length}</div> 
                            </div>
                            
                            <div className="card-actions justify-end">
                                <Link
                                to="/dashboard/class-room" state={{ data: i }} 
                                 >
